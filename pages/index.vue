        ...
        <v-col :cols="8">
          <v-container>
            <s-card class="tw-my-2">
              ...
              <!--              <a :href="record.docLink || record.link">a</a>-->
              <s-card-subtitle>{{ record.docLink || record.link }}</s-card-subtitle>
            </s-card>
            <s-card class="tw-my-2">
              <v-container>
                <p class="tw-text-sm tw-text-gray-500" v-html="highlight(record.mentionPrevious)" />
                <p>{{ record.section }}</p>
                <p v-html="highlight(record.mention)" />
                <p class="tw-text-gray-500" v-html="highlight(record.mentionNext)" />
              </v-container>
            </s-card>
          </v-container>
        </v-col>
