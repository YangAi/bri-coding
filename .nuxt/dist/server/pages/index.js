...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=a5919d18&
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=a5919d18&
...
const offsetProps = (() => {
  return breakpoints.reduce((props, val) => {
    props['offset' + Object(helpers["q" /* upperFirst */])(val)] = {
      type: [String, Number],
      default: null
    };
    return props;
...
const orderProps = (() => {
  return breakpoints.reduce((props, val) => {
    props['order' + Object(helpers["q" /* upperFirst */])(val)] = {
      type: [String, Number],
      default: null
    };
    return props;
...
function makeProps(prefix, def) {
  return VRow_breakpoints.reduce((props, val) => {
    props[prefix + Object(helpers["q" /* upperFirst */])(val)] = def();
    return props;
  }, {});
}
...
var loadable = __webpack_require__(27);
...
var VTextarea = __webpack_require__(104);
...
installComponents_default()(component, {SCard: __webpack_require__(41).default,SCardTitle: __webpack_require__(40).default,SCardSubtitle: __webpack_require__(106).default})
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCheckbox: VCheckbox_VCheckbox,VCol: VCol,VContainer: VContainer["a" /* default */],VRow: VRow,VTextField: VTextField_VTextField,VTextarea: VTextarea_VTextarea})
